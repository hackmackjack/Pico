# 🏁 Batch 10: Communication & Data (091-100)
*Focus: Serial (UART), Data Logging, and Graphing.*

---

## 1️⃣ Project 091: Serial Chat
...
*   **Mistake:** Connecting TX to TX.
    *   **Fix:** Must be TX to RX (Talk to Listen).
*   **Mistake:** Wrong Baud Rate. Both sides must match (9600).
...
## 1️⃣ Project 094: Random Decision
### 2️⃣ Learning Objective
...
## 1️⃣ Project 096: Debounce Button
### 2️⃣ Learning Objective
...
## 1️⃣ Project 097: Sequence Timer
### 2️⃣ Learning Objective
...
## 1️⃣ Project 098: Password Check
### 2️⃣ Learning Objective
