# 🏁 Batch 9: RGB LEDs & Neopixels (081-090)
*Focus: Controlling WS2812B Addressable LEDs.*

---

## 1️⃣ Project 081: Neopixel Hello World
...
*   **Mistake:** Forgetting `Show`. Nothing happens.
*   **Mistake:** Wrong Pin.
*   **Mistake:** Powering too many LEDs from 3.3V (They need 5V usually).
...
## 1️⃣ Project 084: Random Decision
### 2️⃣ Learning Objective
...
## 1️⃣ Project 086: Debounce Button
### 2️⃣ Learning Objective
...
## 1️⃣ Project 087: Sequence Timer
### 2️⃣ Learning Objective
...
## 1️⃣ Project 088: Password Check
### 2️⃣ Learning Objective
