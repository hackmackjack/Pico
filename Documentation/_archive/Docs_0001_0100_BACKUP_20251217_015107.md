...
*   **1. Setup Variables**
    ...
    *   Repeat for: `buttonState`.

*   **1. Setup**
    *   Set GP15 (LED) as Output.
    *   Set GP14 (Button) as Input with PULL_DOWN (so it reads 0 when open).
*   **2. Main Loop**
    *   **Check**: IF `Read Pin 14` is HIGH:
        *   **True**: Set LED ON.
        *   **False**: Set LED OFF.

    *   Handled inside the main loop (polling).
...
*   **1. Setup**
    *   Set LEDs Output, Buttons Input (Pull-Down).
*   **2. Main Loop**
    *   **Check A**: IF Button A is Pressed:
        *   Red ON, Green OFF.
    *   **Check B**: ELSE IF Button B is Pressed:
        *   Green ON, Red OFF.
    *   **Default**: ELSE:
        *   All OFF.
...
*   **1. Setup Variables**
    *   Click the **Variables** category.
    *   Click **Create variable...** and type the name.
    *   Repeat for: `lightLevel`.

*   **1. Setup**
    *   Setup ADC on GP26.
*   **2. Main Loop**
    *   **Measure**: `lightLevel` = Read ADC0.
    *   **Decision**: IF `lightLevel` < 30000 (Dark):
        *   LED ON.
    *   **Else**:
        *   LED OFF.
...
*   **1. Setup Variables**
    *   Click the **Variables** category.
    *   Click **Create variable...** and type the name.
    *   Repeat for: `pressCount`, `lastPressTime`.
*   **Loop**:
    *   IF Button Pressed:
        *   `pressCount` += 1.
        *   Beep (Ack).
...
*   **1. Setup Variables**
    *   Click the **Variables** category.
    *   Click **Create variable...** and type the name.
    *   Repeat for: `flash_count`, `press_count`.
*   **Loop**:
