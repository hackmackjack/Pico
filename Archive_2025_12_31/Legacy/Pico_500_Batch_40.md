# 🏁 Batch 40: Edge AI Basics (391-400)
*Focus: TinyML, Pattern Recognition, and smart decision making on the edge.*

---

## 1️⃣ Project 391: Gesture Recording (Data Collection)
...
*   **Mistake:** Creating "CSV" with spaces (`100, 200, 300`).
    *   **Fix:** Machines prefer compact data (`100,200,300`). Excess spaces can confuse parsers.

### 1️⃣2️⃣ Try This Next
*   Record Gyroscope data too (Rotation) for better accuracy.

---


## 1️⃣ Project 392: Toggle Logic
### 2️⃣ Learning Objective
...
## 1️⃣ Project 394: Random Decision
### 2️⃣ Learning Objective
...
## 1️⃣ Project 396: Debounce Button
### 2️⃣ Learning Objective
...
## 1️⃣ Project 397: Sequence Timer
### 2️⃣ Learning Objective
...
## 1️⃣ Project 398: Password Check
### 2️⃣ Learning Objective
